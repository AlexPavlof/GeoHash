(function (global, factory) {
    ...
    var getBit = function getBit(bits, position) {
    ...
    var getKeyLength = function getKeyLength(zoom) {
      var key;
    ...
    var encodeInt = function encodeInt(latitude, longitude, bitDepth) {
    ...
    var decodeBbox = function decodeBbox(hashString) {
      var isLon = true;
      var maxLat = 90;
      var minLat = -90;
      var maxLon = 180;
    ...
    var decodeBboxInt = function decodeBboxInt(hashInt, bitDepth) {
      bitDepth = bitDepth || DEFAULT_BIT_DEPTH;
      var maxLat = 90;
      var minLat = -90;
      var maxLon = 180;
    ...
    var decodeInt = function decodeInt(hashInt, bitDepth) {
    ...
    var neighborInt = function neighborInt(hashInt, direction, bitDepth) {
      bitDepth = bitDepth || DEFAULT_BIT_DEPTH;
    ...
    var neighbors = function neighbors(hashString) {
    ...
    var neighborsInt = function neighborsInt(hashInt, bitDepth) {
      bitDepth = bitDepth || DEFAULT_BIT_DEPTH;
      var lonlat = decodeInt(hashInt, bitDepth);
      var lat = lonlat.latitude;
      var lon = lonlat.longitude;
    ...
    var bboxesInt = function bboxesInt(minLat, minLon, maxLat, maxLon, bitDepth) {
      bitDepth = bitDepth || DEFAULT_BIT_DEPTH;
    ...
    exports.BASE32_CODES = BASE32_CODES;
    exports.BASE32_CODES_DICT = BASE32_CODES_DICT;
    exports.ENCODE_AUTO = ENCODE_AUTO;
    exports.SIGFIG_HASH_LENGTH = SIGFIG_HASH_LENGTH;
    exports.getBit = getBit;
    exports.getKeyLength = getKeyLength;
    exports.encode = encode;
    exports.encodeInt = encodeInt;
    exports.decodeBbox = decodeBbox;
    exports.decodeBboxInt = decodeBboxInt;
    exports.decode = decode;
    exports.decodeInt = decodeInt;
    exports.neighbor = neighbor;
    exports.neighborInt = neighborInt;
    exports.neighbors = neighbors;
    exports.neighborsInt = neighborsInt;
    exports.bboxes = bboxes;
    exports.bboxesInt = bboxesInt;
    exports.default = geohash;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=geohash.umd.js.map
